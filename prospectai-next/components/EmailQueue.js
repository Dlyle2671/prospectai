      ...
      {editing ? (
        <div style={{ marginBottom: 12 }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '8px 10px', background: '#0f172a', border: '1px solid #334155', borderRadius: 6, color: '#f1f5f9', fontSize: 13, marginBottom: 10, boxSizing: 'border-box' }}
          />
          ...
          <textarea
            ...
            rows={12}
            style={{ width: '100%', padding: '8px 10px', background: '#0f172a', border: '1px solid #334155', borderRadius: 6, color: '#f1f5f9', fontSize: 12, fontFamily: 'inherit', lineHeight: 1.6, resize: 'vertical', boxSizing: 'border-box' }}
          />
          <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
            ...
            <button onClick={cancelEdits} style={{ padding: '6px 14px', borderRadius: 6, border: '1px solid #334155', background: 'transparent', color: '#94a3b8', fontSize: 12, cursor: 'pointer' }}>
              Cancel
            </button>
          </div>
        </div>
...
export default function EmailQueue() {
  ...
  async function handleSend(item) {
    ...
    try {
      ...
      if (data.results?.[0]?.status === 'sent') {
        ...
        showToast('Email sent to ' + item.leadName + '!');
      } else {
  ...
  async function handleSendAllApproved() {
    ...
    showToast('Sent ' + sentCount + ' of ' + approved.length + ' emails');
  }
    ...
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '24px 20px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 20, flexWrap: 'wrap', gap: 12 }}>
        <div>
          ...
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#64748b' }}>Review and approve AI-drafted emails before sending</p>
        </div>
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: '60px 0', color: '#475569' }}>
          ...
          <div style={{ fontSize: 13, color: '#475569' }}>
            {filter === 'all' ? 'Use "Draft All to Queue" on any search results to populate this queue.' : 'Switch filters to see other emails.'}
          </div>
        </div>
      ) : (
        filtered.map(item => (
