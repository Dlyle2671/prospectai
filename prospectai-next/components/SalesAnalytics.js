...
function RepsTab({data, save}){
  ...
  return(
    <div>
      ...
      <div className="sa-card">
        <table className="sa-tbl">
          <thead><tr><th>Name</th><th>Dept</th><th>Professional Services Closed</th><th>Professional Services Quota</th><th>PS %</th><th>FinOps Closed</th><th>FinOps Quota</th><th>FO %</th><th>Managed Services Closed</th><th>Managed Services Quota</th><th>MS %</th><th>Actions</th></tr></thead>
          <tbody>
            {data.reps.map(r=>(
              <tr key={r.id}>
                <td style={{fontWeight:600,color:'#f1f5f9'}}>{r.name}</td>
