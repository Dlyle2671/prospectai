...
const DEFAULT_STATE = { stage: 0, results: [], selectedIndustries: [], selectedEmployeeRanges: [], selectedTitles: [], selectedLocations: [], selectedLimit: 25, activeResultFilters: [], lastPage: 1 };
...
export default function FindLeads() {
  ...
  if (stage === 2) return (
    <div className="fade-up">
      ...
      {filtered.length > 0
        ? filtered.map((p, i) => <LeadCard key={p.id || i} p={p} index={i} />)
