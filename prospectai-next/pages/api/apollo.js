...
export default async function handler(req, res) {
  ...
  try {
        ...
        // For domain searches, broaden email filter; for general searches require verified/guessed
        if(isDomainSearch) {
        ...
        // Industries (general search only)
        if(!isDomainSearch) {
        ...
        // Domain filter — use organization_domains array directly
        if(isDomainSearch) {
        ...
        // For domain searches, include all candidates with any email data
        // For general searches, require has_email flag
