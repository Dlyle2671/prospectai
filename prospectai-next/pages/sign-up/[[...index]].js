...
export default function SignUpPage() {
  ...
  // If user is already signed in and arrives via an invite link (?__clerk_ticket=...),
  // sign them out first so they can complete the invite as the correct new account.
  useEffect(() => {
        const hasInviteToken = router.query.__clerk_ticket || window.location.search.includes('__clerk_ticket');
